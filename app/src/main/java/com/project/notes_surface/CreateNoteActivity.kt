package com.project.notes_surface
...
import com.project.notes_surface.database.NotesDatabase
import com.project.notes_surface.entities.Notes
import com.project.notes_surface.util.FeatureActivity
...
class CreateNoteActivity : BaseActivity(),EasyPermissions.PermissionCallbacks,EasyPermissions.RationaleCallbacks{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        imgMore.setOnClickListener{
            var noteBottomSheetFragment = FeatureActivity.newInstance(noteId)

package com.project.notes_surface.adapter
...
class NotesAdapter() :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NotesViewHolder {
        return NotesViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.align_notes,parent,false)
        )
    }
    ...
    override fun onBindViewHolder(holder: NotesViewHolder, position: Int) {
        ...
        if (arrList[position].color != null){
            ...
            holder.itemView.cardView.setCardBackgroundColor(Color.parseColor(R.color.ColorWhite.toString()))
        }
        ...
        if (arrList[position].noteText != ""){
            holder.itemView.tvDesc.text = arrList[position].noteText
            holder.itemView.tvDesc.visibility = View.VISIBLE
        }else{
            holder.itemView.tvDesc.visibility = View.GONE
        }

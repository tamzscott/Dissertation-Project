...
class FeaturesFragment : BottomSheetDialogFragment() {
    var selectedColor = "#FFFFFF"


    companion object {
        var noteId = -1
        fun newInstance(id:Int): FeaturesFragment{
            val args = Bundle()
...
//        layoutSpeechToText.setOnClickListener{
//            val intent = Intent("bottom_sheet_action")
//            intent.putExtra("action","SpeechToText")
//            LocalBroadcastManager.getInstance(requireContext()).sendBroadcast(intent)
//            dismiss()
//        }
//
